...
export function exportGanttPdf(
  ...
  // End at the last day of the month containing the latest date (no extra months)
  const winEnd = new Date(maxDate.getFullYear(), maxDate.getMonth() + 1, 0)
