...
function MilestoneRow({
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div>
            ...
            <input type="date" value={form.targetDate} onChange={f('targetDate')}
              className="w-full bg-slate-900 text-slate-300 text-sm rounded-lg px-3 py-2 border border-slate-800 focus:outline-none focus:border-blue-500" />
          </div>
          <div>
  ...
  return (
    <div className={clsx(
      ...
      overdue ? 'bg-red-950/10 border-red-800/30' : 'bg-slate-900 border-slate-800 hover:border-slate-800'
    )}>
