              ...
              <div className="space-y-2">
                {SUGGESTIONS.map(s => (
                  <button
                    ...
                    className="w-full text-left text-xs px-3 py-2.5 bg-slate-900/60 hover:bg-slate-700/60 border border-slate-800 hover:border-slate-800 rounded-xl text-slate-300 transition-colors"
                  >
                    {s}
                  </button>
                ))}
        ...
        <form onSubmit={handleSubmit} className="p-4 border-t border-slate-800 shrink-0">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              className="flex-1 resize-none bg-slate-900 border border-slate-800 focus:border-blue-500 rounded-xl px-3 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:outline-none disabled:opacity-50 max-h-32 overflow-y-auto"
