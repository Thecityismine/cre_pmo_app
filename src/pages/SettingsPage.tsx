...
const inp = () => clsx('w-full bg-slate-900 text-slate-100 text-sm rounded-lg px-3 py-2.5 border border-slate-800 focus:outline-none focus:border-blue-500 placeholder-slate-500 disabled:opacity-50 disabled:cursor-not-allowed')
    ...
    <Section title="Project Types" icon={Tag}>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {types.map(t => (
            <div key={t.code} className="flex items-center justify-between px-3 py-2 bg-slate-900/60 rounded-lg border border-slate-800">
        ...
        <div className="border-t border-slate-800 pt-4 space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              maxLength={5}
              className="w-24 bg-slate-900 text-slate-100 text-sm rounded-lg px-3 py-2 border border-slate-800 focus:outline-none focus:border-blue-500 placeholder-slate-600 font-mono uppercase"
            />
            <input
              value={label}
              ...
              className="flex-1 bg-slate-900 text-slate-100 text-sm rounded-lg px-3 py-2 border border-slate-800 focus:outline-none focus:border-blue-500 placeholder-slate-600"
            />
            <button
              onClick={handleAdd}
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="flex-1 bg-slate-900 border border-slate-800 text-slate-200 text-sm rounded-lg px-3 py-2 focus:outline-none focus:border-blue-500"
          >
