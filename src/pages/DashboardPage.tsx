...
function PendingDecisionsPanel({
  ...
  return (
    <div className="bg-slate-900 border border-amber-800/30 rounded-xl overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-800 bg-amber-950/20">
    ...
    <div className="space-y-6">
      ...
      {myName && (() => {
        ...
        return (
          <div className="bg-slate-900 border border-blue-800/40 rounded-xl overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-800 bg-blue-950/20">
            ...
            <div className="flex gap-4 px-4 py-2 border-t border-slate-800/50 text-[10px] text-slate-400">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        {!tasksLoading && (overdue.length > 0 || upcoming.length > 0) ? (
          <div className="space-y-4">
            {overdue.length > 0 && (
              <div className="bg-slate-900 border border-red-800/40 rounded-xl overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-800 bg-red-950/20">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl flex items-center justify-center py-8 text-slate-400">
                  ...
                  {active.map((p, i) => {
                    ...
                    return (
                      <tr
                        ...
                        onClick={() => navigate(`/projects/${p.id}`)}
                        className={clsx(
                          'border-t border-slate-800 hover:bg-slate-700/40 cursor-pointer transition-colors',
