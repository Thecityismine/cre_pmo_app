  ...
  return (
    <div className="space-y-1">
      ...
      <div className="h-1.5 bg-slate-700 rounded-full overflow-hidden">
        <div className={clsx('h-full rounded-full transition-all duration-700 bar-fill', barColor)} style={{ width: `${pct}%` }} />
      </div>
    </div>
  )
}
...
{overdueTaskCount > 0 && (
      ...
      {project.totalBudget > 0 && (
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
          ...
          <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
            <div
              className={clsx('h-full rounded-full transition-all duration-700 bar-fill', budgetUsed > 90 ? 'bg-red-500' : budgetUsed > 70 ? 'bg-amber-500' : 'bg-emerald-500')}
      ...
      <div className="fixed bottom-28 right-6 md:bottom-8 md:right-8 z-[55] flex flex-col items-end gap-2">
        {/* FAB menu */}
        {fabOpen && (
