...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 safe-area-inset">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900 border border-slate-600 rounded-2xl p-6 space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-slate-700 hover:bg-slate-600 text-slate-100 text-sm font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50"
          >
